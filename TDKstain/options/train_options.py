...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--display_freq', type=int, default=1000, help='frequency of saving training results to html and disks')
        parser.add_argument('--print_freq', type=int, default=100, help='frequency of showing training results on console')
        parser.add_argument('--no_html', action='store_true', help='do not save intermediate training results to [opt.checkpoints_dir]/[opt.name]/web/')
        # if use tensorboard visualization
        parser.add_argument('--use_tensorboard', action='store_true', default=True, help='save intermediate training losses to [opt.checkpoints_dir]/[opt.name]/tensorboard/')
