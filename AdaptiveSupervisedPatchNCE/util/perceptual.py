...
class PerceptualHashValue(nn.Module):
    ...
    def forward(self, inp, target):
        ...
        for layer in self.layers:
            ...
            # Note: Arshmeet 
            # (1) Take feature map (B, C, H, W) at each layer
            # (2) Average over H, W to get one scalar per channel. 
            # (3) Get absolute difference per channel. 
            # (4) Count what fraction of channels differ by more than the threshold 
            # => PHV. 
